...
path = '/home/haho3703/TIEGCM/TIEGCM_files/';
linear=1;

%----------------
ut_want = 1;                      % Specify the universal time. This is the first UT time in the TIEGCM file
alt_want = 120;                   % Specify the desired altitude in km
geopot_alt_want = 400;
pdrag = 1;                      % set to 1 to use pdrag file, 0 to use ctrSS file zp = ln(p0/p)
zp_want = 3.125;                % pressure level to condense to 
zp_name = '3,125';              % to use for file outputs
constraint = 'geometric altitude';  % which constraint do you want? do you want pressure level, geometric altitude, or geopotential altitude
...
if strcmp(constraint,'pressure level')
    ...
    % compress the helium density to the presure level you wan
